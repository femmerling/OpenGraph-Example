...
(function(/*! Stitch !*/) {
  ...
  exports.MainRouter = (function(_super) {
    ...
    MainRouter.prototype.home = function() {
      return $('body').html(app.views.home.render());
    };
  ...
  (function() {
    (function() {
      ...
      __out.push('<div id="content">\n  <h2>Use Example</h2>\n  <p>click the button below to test your app. Check your result in the console.</p>\n  <input type="submit" id="try" value="try"/>\n</div>\n\n');
  ...
  var homeTemplate, loginTemplate,
  ...
  exports.HomeView = (function(_super) {
    ...
    HomeView.prototype.el = '#content-area';
    ...
    HomeView.prototype.render = function() {
      ...
      FB.getLoginStatus(function(response) {
        if (response.status === 'connected') {
          return $(_this.el).html(homeTemplate());
        } else {
    ...
    HomeView.prototype.do_graph = function(event) {
      var _this = this;
      event.preventDefault();
      return FB.api('me/ogex-ice:try', 'POST', {
        example: 'http://emmerling-sandbox.appspot.com/'
      }, function(response) {
        if (!response || response.error) {
          ...
          return console.log("Post ID: " + response.id);
        }
      });
    };
